...
- **2026-07-13**: BALTRAD processing was down late September/early October 2025, resulting in a gap of coverage for all countries between 2025-09-26 and 2025-10-07 (~12 days). This **2025 gap is remedied for all countries**: we received hdf5 vp data from SMHI that is processed the same way as it would be on BALTRAD. We uploaded those data to the bucket, completing the gap, but kept any existing data (on the start and end date). See [#113](https://github.com/aloftdata/data-repository/issues/113) for details.
